...
// Get all roles.
func ListRoles(c pcc.Client) ([]Role, error) {
	var ans []Role
...
// Get a specific role.
func GetRole(c pcc.Client, name string) (*Role, error) {
...
// Create a new role.
func CreateRole(c pcc.Client, role Role) error {
	return c.Request(http.MethodPost, RolesEndpoint, nil, role, nil)
}

// Update an existing role.
func UpdateRole(c pcc.Client, role Role) error {
	return c.Request(http.MethodPut, RolesEndpoint, nil, role, nil)
}

// Delete an existing role.
func DeleteRole(c pcc.Client, name string) error {
